...
#import "Scanner-Bridging-Header.h"
#import "Scan_Cad-Swift.h"
...
@property MFMailComposeViewController *paidMailViewController;
               ...
               bundle:(NSBundle *)nibBundleOrNil
{
    ...
    UIBarButtonItem *emailButton = [[UIBarButtonItem alloc] initWithTitle:@"Done"
                                                                   style:UIBarButtonItemStylePlain
                                                                  target:self
                        ...
                        error:(NSError *)error
{
    ...
    [self.paidMailViewController dismissViewControllerAnimated:YES completion:nil];
}
...
- (void)emailMesh
{
    //emailMesh is called when email button is pressed
    self.mailViewController = [[MFMailComposeViewController alloc] init];
    self.paidMailViewController = [[MFMailComposeViewController alloc] init];
    ...
    self.paidMailViewController.mailComposeDelegate = self;
    
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        self.mailViewController.modalPresentationStyle = UIModalPresentationFormSheet;
        self.paidMailViewController.modalPresentationStyle = UIModalPresentationFormSheet;
    ...
    [self.mailViewController setSubject:@"Free 3D Model"];
    [self.paidMailViewController setSubject:@"Paid 3D Model"];
    ...
    [self.paidMailViewController addAttachmentData:[NSData dataWithContentsOfFile:screenshotPath] mimeType:@"image/jpeg" fileName:screenshotFilename];
    ...
    [self.paidMailViewController addAttachmentData:[NSData dataWithContentsOfFile:zipPath] mimeType:@"application/zip" fileName:zipFilename];
    
    //[self presentViewController:self.mailViewController animated:YES completion:^(){}];

    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"MainStoryboard" bundle:nil];
    FormatSelectionViewController *formatVC = [storyboard instantiateViewControllerWithIdentifier:@"formatVC"];
    [formatVC setModalPresentationStyle:UIModalPresentationFullScreen];
    //formatVC.view.translatesAutoresizingMaskIntoConstraints = false;

    self.navigationController.navigationBar.translucent = NO;

    UINavigationBar *bar = [self.navigationController navigationBar];
    //self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:30/255 green:36/255 blue:45/255 alpha:1.0];

    [bar setTintColor:[UIColor colorWithRed:30/255 green:36/255 blue:45/255 alpha:1.0]];
    
    //[bar backgroundColor:[UIColor colorWithRed:30/255 green:36/255 blue:45/255 alpha:1.0]]

    [formatVC setMailVCWithMailVC:self.mailViewController paidVC:self.paidMailViewController];
